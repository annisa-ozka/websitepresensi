...
<?php $__env->startSection('container'); ?>
    <main id="main" class="main">
        <div class="pagetitle">
            ...
            <nav>
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="/dashboardlecturer/utslist">List UAS</a></li>
        ...
        <br>
        <a href="/dashboardlecturer/uaslistdetail?schedule_id=<?php echo e($schedule->id); ?>"
            class="btn rounded-bottom btn-success mx-3">
            <- Kembali ke List UAS</a>
...
<?php echo $__env->make('dashboard.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Yana\Desktop\0.SKRIPSI\3. PROGRAM\UPDATE TERAKHIR FIX\Website-Absensi\resources\views/dashboard/lecturer/printattendanceuas.blade.php ENDPATH**/ ?>