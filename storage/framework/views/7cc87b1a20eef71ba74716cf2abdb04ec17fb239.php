                        ...
                        <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
                            ...
                            <div class="card mb-3">
                                ...
                                <div class="card-body">
                                    ...
                                    <form method="POST" action="<?php echo e(route('register')); ?>" class="row g-3 needs-validation"
                                        novalidate>
                                        <?php echo csrf_field(); ?>

                                        <?php if(Request::is('registerlecturer')): ?>
                                        ...
                                        <?php if(Request::is('registerstudent')): ?>
...
<?php echo $__env->make('login.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Yana\Desktop\0.SKRIPSI\3. PROGRAM\UPDATE TERAKHIR FIX\Website-Absensi\resources\views/login/register.blade.php ENDPATH**/ ?>